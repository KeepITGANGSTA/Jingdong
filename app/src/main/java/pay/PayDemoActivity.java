...
import com.bwie.jingdong.PaySuccess;
...
public class PayDemoActivity extends FragmentActivity implements AlertBillPresentView{
...
//	private static final String URL_JSON = "http://169.254.63.148:8080/alipayServer/AlipayDemo";
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        System.out.println("商品序列号~~~~~~~~~~"+orderid);
                        parms.put("orderId",orderid);
                        alertBillPresent.AlertBill(OkHttpMethed.POST, Api.AlertBill,parms);
                        Toast.makeText(PayDemoActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        Intent intent=new Intent(PayDemoActivity.this, PaySuccess.class);
    ...
    private IWXAPI api;
    private AlertBillPresent alertBillPresent;
    private int orderid;
    private int uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alertBillPresent = new AlertBillPresent(this,this);
...
//    }
    ...
    public void AlertBillFail(String resutl) {
        System.out.println("修改失败---"+resutl);
    }

    @Override
    public void AlertBillSuccessFail(String resutl) {
        System.out.println("修改成功---"+resutl);
        finish();
    }
}
